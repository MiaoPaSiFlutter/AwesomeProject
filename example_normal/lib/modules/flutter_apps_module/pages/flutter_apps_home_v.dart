...
import '../config/flutter_apps_config.dart';

class FlutterAppsHomePage extends StatefulWidget {
  const FlutterAppsHomePage({super.key});
  @override
  State<StatefulWidget> createState() {
    return FlutterAppsHomePageState();
  }
}
