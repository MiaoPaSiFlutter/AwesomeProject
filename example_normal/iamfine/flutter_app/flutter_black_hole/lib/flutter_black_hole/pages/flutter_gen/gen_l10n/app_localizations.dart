...
class _AppLocalizationsDelegate extends LocalizationsDelegate<AppLocalizations> {
  ...
  @override
  bool isSupported(Locale locale) => <String>['ar', 'be', 'bn', 'cs', 'da', 'de', 'el', 'en', 'es', 'fa', 'fr', 'gu', 'he', 'hi', 'hu', 'id', 'it', 'ja', 'km', 'kn', 'ko', 'ml', 'mn', 'mr', 'ne', 'nl', 'or', 'pa', 'pl', 'pt', 'ru', 'sq', 'sv', 'ta', 'te', 'tr', 'uk', 'ur', 'vi', 'zh'].contains(locale.languageCode);
